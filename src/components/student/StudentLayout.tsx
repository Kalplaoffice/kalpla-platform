...
const navigation = [
  { name: 'Dashboard Home', href: '/student/dashboard', icon: HomeIcon },
  { name: 'Courses', href: '/student/courses', icon: AcademicCapIcon },
  { name: 'KSMP Progress', href: '/student/ksmp', icon: UserGroupIcon },
  { name: 'Assignments', href: '/student/assignments', icon: DocumentTextIcon },
  { name: 'Grades / Transcript', href: '/student/grades', icon: ChartBarIcon },
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white shadow-xl">
          <div className="flex h-16 items-center justify-between px-4 border-b border-gray-200">
            <h1 className="text-lg font-semibold text-gray-900">Kalpla Student</h1>
            <button

...
export default function SignInPage() {
  ...
  useEffect(() => {
    if (authenticatedUser) {
      ...
      const dashboardPath = getDashboardPath(authenticatedUser as User);
  ...
  useEffect(() => {
    if (authenticatedUser && !hasSetUser.current) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="relative min-h-screen flex">
        {/* Left Side - Features */}
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 p-12 flex-col justify-center">
          <div className="max-w-md">
            ...
            <p className="text-xl text-blue-100 mb-12">
              Continue your path to success with our comprehensive educational platform
            </p>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
              ...
              <Authenticator
                ...
                components={{
                  SignIn: {
                    Header() {
                      return null; // We'll use our custom header above
                    },
                    Footer() {
                      return (

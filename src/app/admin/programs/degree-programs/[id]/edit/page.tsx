...
// Mock data for the program being edited
const mockProgram = {
  id: 1,
...
export default function EditDegreeProgramPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    const loadProgram = async () => {
      ...
      setFormData({
        ...
        duration: mockProgram.duration,
        mode: mockProgram.mode,
        schedule: mockProgram.schedule,
        description: mockProgram.description,
        features: mockProgram.features,
        advantages: mockProgram.advantages,
        eligibility: mockProgram.eligibility,
        targetAudience: mockProgram.targetAudience,
        registrationLink: mockProgram.registrationLink,
        image: mockProgram.image,
        status: mockProgram.status as 'active' | 'inactive'
      });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Updating degree program:', formData);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Edit Degree Program</h1>
